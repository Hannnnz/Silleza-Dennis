...
<body>
    ...
    <div class="card">
        ...
        <div class="card-body">
                <div class="user-info">
                    <h3><i class="fas fa-info-circle"></i> Current User</h3>
                    <p><strong>ID:</strong> <?= $user['id'] ?> | <strong>Username:</strong> <?= htmlspecialchars($user['username']) ?></p>
                </div>
                
                <form action="<?= site_url('users/update/' . $user['id']) ?>" method="POST" id="updateForm">
                    <div class="form-group form-animation">
                        ...
                        <div class="input-wrapper">
                            <i class="fas fa-user"></i>
                            <input type="text" name="username" id="username" value="<?= htmlspecialchars($user['username']) ?>" required placeholder="Enter username">
                        </div>
                    </div>
                    ...
                    <div class="form-group form-animation">
                        ...
                        <div class="input-wrapper">
                            <i class="fas fa-envelope"></i>
                            <input type="email" name="email" id="email" value="<?= htmlspecialchars($user['email']) ?>" required placeholder="Enter email address">
                </div>
                </div>
            ...
            inputs.forEach(input => {
                input.addEventListener('input', function() {
                    ...
                    if (this.value !== originalValues[fieldName]) {
                        ...
                        this.parentElement.querySelector('i').style.color = '#f59e0b';
                    } else {
                        this.style.borderColor = '#e5e7eb';
                        this.parentElement.querySelector('i').style.color = '#9ca3af';
                    }
